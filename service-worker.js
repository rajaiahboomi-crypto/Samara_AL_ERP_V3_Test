const CACHE='samara-care-erp-v3.2.1';
const ASSETS=['./','./index.html','./styles.css?v=3.2.1','./app.js?v=3.2.1','./config.js?v=3.2.1','./manifest.webmanifest?v=3.2.1','./icons/icon-192.png','./icons/icon-512.png'];
