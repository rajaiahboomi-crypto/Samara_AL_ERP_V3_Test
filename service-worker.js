const CACHE='samara-care-erp-v3.6.2';
const ASSETS=['./','./index.html','./styles.css?v=3.6.2','./app.js?v=3.6.2','./config.js?v=3.6.2','./manifest.webmanifest?v=3.6.2','./icons/icon-192.png','./icons/icon-512.png'];
