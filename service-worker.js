const CACHE='samara-care-erp-v3.4.4';
const ASSETS=['./','./index.html','./styles.css?v=3.4.4','./app.js?v=3.4.4','./config.js?v=3.4.4','./manifest.webmanifest?v=3.4.4','./icons/icon-192.png','./icons/icon-512.png'];
