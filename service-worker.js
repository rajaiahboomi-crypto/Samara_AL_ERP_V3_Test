const CACHE='samara-care-erp-v3.4.1';
const ASSETS=['./','./index.html','./styles.css?v=3.4.1','./app.js?v=3.4.1','./config.js?v=3.4.1','./manifest.webmanifest?v=3.4.1','./icons/icon-192.png','./icons/icon-512.png'];
