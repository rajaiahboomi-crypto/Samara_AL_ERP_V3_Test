const CACHE='samara-care-erp-v3.6.1';
const ASSETS=['./','./index.html','./styles.css?v=3.6.1','./app.js?v=3.6.1','./config.js?v=3.6.1','./manifest.webmanifest?v=3.6.1','./icons/icon-192.png','./icons/icon-512.png'];
