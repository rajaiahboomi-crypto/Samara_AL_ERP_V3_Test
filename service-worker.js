const CACHE='samara-care-erp-v3.2.3';
const ASSETS=['./','./index.html','./styles.css?v=3.2.3','./app.js?v=3.2.3','./config.js?v=3.2.3','./manifest.webmanifest?v=3.2.3','./icons/icon-192.png','./icons/icon-512.png'];
